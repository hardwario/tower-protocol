...
fn golden_hello() {
    ...
    assert_eq!(
        got,
        [0x03, 0x20, 0x01, 0x09, 0x01, 0x02, 0x66, 0x77, 0xf2, 0xae, 0x73, 0xdf, 0x00]
    );
}
...
fn golden_log() {
    ...
    assert_eq!(
        got,
        [
            0x03, 0x21, 0x07, 0x0f, 0x01, 0x84, 0x86, 0x88, 0x08, 0x01, 0x6d, 0x02, 0x68, 0x69,
            0xf6, 0x47, 0x63, 0x6d, 0x00
        ]
    );
}
...
fn golden_dropped() {
    ...
    assert_eq!(got, [0x03, 0x26, 0x02, 0x07, 0xac, 0x02, 0xfb, 0x77, 0x16, 0xce, 0x00]);
}
...
fn golden_shell_response() {
    ...
    assert_eq!(
        got,
        [
            0x03, 0x24, 0x09, 0x02, 0x05, 0x01, 0x09, 0x01, 0x02, 0x6f, 0x6b, 0x93, 0x2e, 0x9a,
            0xd8, 0x00
        ]
    );
}
